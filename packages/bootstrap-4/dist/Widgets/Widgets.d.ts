...
declare const _default: {
    ...
    TextWidget: ({ id, required, readonly, disabled, type, label, value, onChange, onBlur, onFocus, autofocus, options, schema, rawErrors, }: import("../TextWidget/TextWidget").TextWidgetProps) => JSX.Element;
